...
func ValidateUsername(username string) error {
	...
	// Optimization: Manual byte iteration avoids regex engine overhead for simple ASCII character classes.
	// Benchmark testing showed an improvement from ~703.6 ns/op to ~22.56 ns/op.
