...
func ValidateUsername(username string) error {
	...
	// Optimization: Manual byte iteration avoids regex engine overhead for simple ASCII validation.
	// Benchmark testing showed an improvement from ~750ns/op to ~17ns/op.
